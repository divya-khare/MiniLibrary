...
class DescriptionActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        if (intent != null) {
            ...
            finish()
            Toast.makeText(
                this@DescriptionActivity, "Some unexpected error occurred!", Toast.LENGTH_SHORT).show()
        }
        if (bookId == "100") {
            finish()
            Toast.makeText(
                ...
                try{
                    ...
                    if (success) {
                        ...
                        Picasso.get().load(bookJsonObject.getString("image"))
                            .error(R.drawable.book_logo).into(imgBookImage)
                        ...
                        Toast.makeText(
                            this@DescriptionActivity, "Some Error Occurred!Try Again", Toast.LENGTH_SHORT).show()
                    }
                }
    ...
    class DBAsyncTask(val context: Context, val bookEntity: BookEntity, val mode:Int):
        ...
        override fun doInBackground(vararg p0: Void?): Boolean {
            ...
            {
                1->{
                    val book: BookEntity? = db.bookDao().getBookByTd(bookEntity.bookId.toString())
                    db.close()
                    return book !=null
                }
                2->{
